...
import { X, Plus, Mail, Lock, AlertCircle, CheckCircle, Loader2 } from 'lucide-react';
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md bg-slate-900 border border-white/10 rounded-3xl shadow-2xl shadow-black/60 p-7">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 id="add-user-modal-title" className="text-xl font-bold text-white">
            Create New User
          </h2>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-4" noValidate>
          <div>
            <label className="block text-xs font-medium text-slate-400 mb-1.5" htmlFor="admin-add-email">
          ...
          <div>
            <label className="block text-xs font-medium text-slate-400 mb-1.5" htmlFor="admin-add-password">
          ...
          <div>
            <label className="block text-xs font-medium text-slate-400 mb-1.5" htmlFor="admin-add-role">
              Role
            </label>
            <select
              id="admin-add-role"
